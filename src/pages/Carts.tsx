          ...
          <div>
            ...
            <div className="flex items-center justify-between mt-[10px] gap-4">
              <button
                ...
                className={`w-1/2 flex items-center gap-x-3 py-3 px-7 bg-white rounded-[16px] hover:outline-none hover:ring-1 hover:ring-[#F39D84] ${paymentMethod === 'transfer' ? 'border-[2px] border-[#F39D84]' : ''}`}
              >
                <img
              ...
              <button
                ...
                className={`w-1/2 flex items-center gap-x-3 py-3 px-7 bg-white rounded-[16px] hover:outline-none hover:ring-1 hover:ring-[#F39D84] ${paymentMethod === 'manual' ? 'border-[2px] border-[#F39D84]' : ''}`}
              >
                <img
