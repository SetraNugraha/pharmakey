    ...
    <>
      <section className="h-full">
        ...
        <div className="pt-[30px] px-[16px] flex items-center">
          <Link to="/" className="p-2 bg-white flex justify-center items-center rounded-full ring-1 ring-black hover:ring-0 hover:bg-red-500 transition-all duration-200 ease-in-out group">
        ...
        <div className="flex flex-col items-center justify-center gap-5 mt-[20px]">
          <img src="assets/img/profile-default.png" alt="product" className="h-[120px] max-w-[150px] p-2 bg-white rounded-full" />
